...
if (!(isset($_SESSION['login_userid']) && $_SESSION['login_userid'])) {
    session_destroy();
    if ($_SERVER['PHP_SELF'] != '/Faculty Head Login.php') {
        header("Location: ../../Faculty Head Login.php");
        exit;
    }
    if (basename($_SERVER['PHP_SELF']) != 'Faculty Head Login.php') {
        header("Location: ../../Faculty Head Login.php");
        exit;
    }
}
